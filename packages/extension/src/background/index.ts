...
import { hasTab, sendMessageToActiveTabs, sendMessageToActiveTabsAndUi } from './activeTabs'
import { handleAddressMessage } from './addressMessaging'
import { BackgroundService, HandleMessage, UnhandledMessage } from './background'
...
;(async () => {
  ...
  const onAutoLock = () => sendMessageToActiveTabsAndUi({ type: 'DISCONNECT_ADDRESS' })
