...
export const SeedRecoveryScreen: FC = () => {
  ...
  const disableSubmit = useMemo(() => Boolean(!seedPhraseInput || error), [seedPhraseInput, error])
  ...
  return (
    <>
      ...
      <ConfirmScreen
        ...
        smallTopPadding
      >
        <P>Enter each of the 24 words from your recovery phrase separated by a space</P>
        <TextArea
          ref={textAreaElement}
