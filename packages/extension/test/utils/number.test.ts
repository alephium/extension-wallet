...
import { isNumeric, prettifyCurrencyNumber, prettifyNumber, prettifyTokenNumber } from '../../src/shared/utils/number'
  ...
  describe('when valid', () => {
    describe('when using default currency config', () => {
      test('should return pretty currency value', () => {
        ...
        expect(prettifyCurrencyNumber('1199.05823328686698812')).toEqual('1,199.06')
      })
    })
